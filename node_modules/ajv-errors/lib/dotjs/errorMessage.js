  ...
  if (it.createErrors !== false) {
    ...
    if (typeof $schema == "object") {
        ...
        if (arr1) {
          ...
          while (i1 < l1) {
            ...
            if (INTERPOLATION.test($schema[$k])) {
              ...
              out +=
                "" +
                it.util.toQuotedString($k) +
                ": " +
                templateFunc($schema[$k]) +
                " ";
              $comma = true;
            }
          }
      ...
      if ($hasKeywordProps) {
        out +=
          ...
          $errors +
          " = " +
          JSON.stringify($keywordPropErrors) +
          "; var " +
          $paramsErrors +
          ", " +
          $propParam +
          ...
          $keywordPropParams +
          " = " +
          JSON.stringify($config.KEYWORD_PROPERTY_PARAMS) +
          ";  var " +
          $templates +
          " = { ";
        var $comma = false;
            ...
            if (arr3) {
              ...
              while (i3 < l3) {
                ...
                if (INTERPOLATION.test($keywordMsgs[$prop])) {
                  ...
                  out +=
                    "" +
                    it.util.toQuotedString($prop) +
                    ": " +
                    templateFunc($keywordMsgs[$prop]) +
                    " ";
                  $innerComma = true;
                }
              }
            ...
            while (i5 < l5) {
              ...
              if (INTERPOLATION.test($schema.properties[$k])) {
                ...
                out +=
                  ...
                  it.util.toQuotedString($k) +
                  ": " +
                  templateFunc($schema.properties[$k]) +
                  " ";
                $comma = true;
              }
            }
    ...
    if ($schemaMessage) {
      ...
      out +=
        ...
        $errors +
        " } , message: " +
        templateExpr($schemaMessage) +
        " ";
      if (it.opts.verbose) {
        out +=
          " , schema: " +
          it.util.toQuotedString($schemaMessage) +
          " , parentSchema: validate.schema" +
          it.schemaPath +
          " , data: " +
          $data +
  ...
  function templateExpr(str) {
    ...
    var expr =
      ...
      str.replace(INTERPOLATION_REPLACE, function($0, $1) {
        return (
          "' + JSON.stringify(" +
          it.util.getData($1, $dataLvl, it.dataPathArr) +
          ") + '"
        );
      }) +
      "'";
