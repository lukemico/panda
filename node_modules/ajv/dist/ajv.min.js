  ...
  })(
    {
                  ...
                  try {
                    ...
                    if (e instanceof s)
                      return (function(e) {
                        ...
                        t ||
                          (t = n._loadingSchemas[r] = n._opts.loadSchema(
                            r
                          )).then(a, a);
                        return t
                          .then(function(e) {
        ...
        function(e, r, t) {
          ...
          r.exports = function c(e, u, h, r) {
            ...
            function w(e, r, t, a) {
              ...
              if (r.schema != u.schema) return c.call(d, e, r, t, a);
              var o,
                i = !0 === e.$async,
                n = O({
                  isTop: !0,
              ...
              return (
                ...
                i && (o.$async = !0),
                !0 === f.sourceCode &&
                  (o.source = { code: n, patterns: v, defaults: g }),
                o
              );
            }
            function S(e, r, t) {
              ...
              if (!t && u.refs) {
                var i = u.refs[r];
                if (void 0 !== i) return (s = b(r, (a = u.refVal[i]))), _(a, s);
              }
              s = b(r);
              var n = $.call(d, w, u, r);
              if (void 0 === n) {
            ...
            function R(e, r, t, a) {
              ...
              if (s && !1 !== d._opts.validateSchema) {
                ...
                if (!o) {
                  var i =
                    "keyword schema is invalid: " + d.errorsText(s.errors);
              ...
              var h = y.length;
              return { code: "customRule" + h, validate: (y[h] = n) };
            }
          };
        },
        {
                  ...
                  if ("" !== r) {
                    ...
                    if (
                      (void 0 !== i &&
                        (c +=
                          "/" +
                          ("number" == typeof i ? i : g.escapeFragment(i))),
                      "string" == typeof n)
                    ) {
          ...
          r.exports = {
            ...
            finalCleanUpCode: function(e, r) {
              ...
              t &&
                2 == t.length &&
                (e = r
                  ? e.replace(m, "").replace(y, P)
                  : e.replace(p, "").replace(v, g));
                ...
                for (var P, E = -1, w = y.length - 1; E < w; )
                  (P = y[(E += 1)]),
                    ...
                    (a +=
                      ...
                      ") { "),
                    (p += "}");
              (r.compositeRule = f.compositeRule = g),
                (a += " " + p + " if (!" + h + ") {   var err =   "),
                !1 !== r.createErrors
                  ? ((a +=
      ...
      22: [
        function(e, r, t) {
          ...
          r.exports = function(e, r, t) {
            ...
            var k = d.baseId;
            for (var w in m) {
              e.util.schemaHasRules((y = m[w]), e.RULES.all) &&
                ((a +=
                  " " +
                  p +
                  " = true; if ( " +
            ...
            if (
              ...
              if (_)
                for (var F, x = -1, R = _.length - 1; x < R; )
                  if (
                    ((F = _[(x += 1)]), e.util.schemaHasRules(F, e.RULES.all))
                  ) {
                    a +=
      ...
      30: [
        function(e, r, t) {
          ...
          r.exports = function(e, r, t) {
            ...
            var E = i;
            if (E)
              for (var w, S = -1, b = E.length - 1; S < b; )
                (w = E[(S += 1)]),
        ...
        function(e, r, t) {
          ...
          r.exports = function(e, r, t) {
            ...
            var p = "valid" + d.level,
              ...
              _ = E.length || S.length,
              F = !1 === b,
              x = "object" == typeof b && Object.keys(b).length,
              ...
              if ("all" == R) a += " delete " + u + "[" + m + "]; ";
                ...
                if (
                  ...
                  if ("failing" == R) {
                    ...
                    var M = e.validate(d);
                    (d.baseId = j),
                      e.util.varOccurences(M, y) < 2
                        ? (a += " " + e.util.varReplace(M, y, H) + " ")
                        : (a += " var " + y + " = " + H + "; " + M + " "),
                      (a +=
                        " if (!" +
                        p +
            ...
            if (E.length) {
              var K = E;
              if (K)
                for (var J, Z = -1, G = K.length - 1; Z < G; ) {
                  if (
                    ((J = K[(Z += 1)]),
                    e.util.schemaHasRules((ie = i[J]), e.RULES.all))
                  ) {
                    var Y = e.util.getProperty(J),
                      W = ((H = u + Y), B && void 0 !== ie.default);
                    (d.schema = ie),
                      (d.schemaPath = n + Y),
                      ...
                      (d.dataPathArr[g] = e.util.toQuotedString(J));
                    M = e.validate(d);
                    if (((d.baseId = j), e.util.varOccurences(M, y) < 2)) {
            ...
            if (S.length) {
              ...
              if (te)
                for (var ae, se = -1, oe = te.length - 1; se < oe; ) {
                  ...
                  if (
                    ((ae = te[(se += 1)]),
                    e.util.schemaHasRules((ie = w[ae]), e.RULES.all))
                  ) {
                    (d.schema = ie),
                      (d.schemaPath =
                        e.schemaPath +
        ...
        function(e, r, t) {
          ...
          r.exports = function(e, r, t) {
            ...
            if (
              ...
              var _ = e.validate(d);
              (d.baseId = w),
                e.util.varOccurences(_, y) < 2
                  ? (a += " " + e.util.varReplace(_, y, S) + " ")
                  : (a += " var " + y + " = " + S + "; " + _ + " "),
        ...
        function(e, r, t) {
          ...
          r.exports = function(a, e, r) {
            ...
            if (
              ...
              var n = a.level,
                l = a.dataLevel,
                c = a.schema[(e = "false schema")],
                u = a.schemaPath + a.util.getProperty(e),
                h = a.errSchemaPath + "/" + e,
                d = !a.opts.allErrors,
                f = "data" + (l || ""),
                p = "valid" + n;
              if (!1 === a.schema) {
                a.isTop ? (d = !0) : (t += " var " + p + " = false; "),
                  (K = K || []).push(t),
                  (t = ""),
                  !1 !== a.createErrors
                    ? ((t +=
            ...
            if (a.isTop) {
              var v = a.isTop;
              (n = a.level = 0), (l = a.dataLevel = 0), (f = "data");
              ...
              (n = a.level), (f = "data" + ((l = a.dataLevel) || ""));
            ...
            var g = "",
              ...
              E = Array.isArray(P);
            if (
              (E && 1 == P.length && ((P = P[0]), (E = !1)), a.schema.$ref && o)
            ) {
            ...
            if (
              ...
              if (a.opts.coerceTypes)
                var w = a.util.coerceToTypes(a.opts.coerceTypes, P);
              var S = a.RULES.types[P];
              if (w || E || !0 === S || (S && !J(S))) {
                (u = a.schemaPath + ".type"),
                  (h = a.errSchemaPath + "/type"),
                  (u = a.schemaPath + ".type"),
                  (h = a.errSchemaPath + "/type");
                if (
                  ((t +=
                    " if (" +
                    a.util[E ? "checkDataTypes" : "checkDataType"](P, f, !0) +
                    ") { "),
                  w)
                ) {
                  var b = "dataType" + n,
                  ...
                  (t += " " + f + " = " + _ + "; "),
                    ...
                    (t +=
                      ...
                      j +
                      "[" +
                      (l ? a.dataPathArr[l] : "parentDataProperty") +
                      "] = " +
                      _ +
                      "; } ");
                } else {
            ...
            if (a.schema.$ref && !o)
              ...
              var O = a.RULES;
              if (O)
                for (var I = -1, A = O.length - 1; I < A; )
                  if (J((S = O[(I += 1)]))) {
                    if (
                      (S.type &&
                        (t +=
                          " if (" + a.util.checkDataType(S.type, f) + ") { "),
                      a.opts.useDefaults && !a.compositeRule)
                    )
                      if ("object" == S.type && a.schema.properties) {
                        c = a.schema.properties;
                        var C = Object.keys(c);
                        if (C)
                          for (var k, L = -1, z = C.length - 1; L < z; ) {
                            if (void 0 !== (N = c[(k = C[(L += 1)])]).default)
                              (t +=
                                "  if (" +
                                (U = f + a.util.getProperty(k)) +
                                " === undefined) " +
                                U +
                                " = "),
                                (t +=
                                  "shared" == a.opts.useDefaults
                                    ? " " + a.useDefault(N.default) + " "
                                    : " " + JSON.stringify(N.default) + " "),
                                (t += "; ");
                          }
                      } else if (
                        "array" == S.type &&
                    ...
                    var Q = S.rules;
                    if (Q)
                      for (var V, H = -1, M = Q.length - 1; H < M; )
                        if (Z((V = Q[(H += 1)]))) {
              ...
              v
                ? (s
                    ...
                    : ((t += " validate.errors = vErrors; "),
                      (t += " return errors === 0;       ")),
                  (t += " }; return validate;"))
                : (t += " var " + p + " = errors === errs_" + n + ";"),
              (t = a.util.cleanUpCode(t)),
              v && (t = a.util.finalCleanUpCode(t, s)),
              t
            );
          };
        },
        ...
        function(e, r, t) {
          ...
          var p = (r.exports = function(e, r, t) {
            "function" == typeof r && ((t = r), (r = {})),
              (function e(r, t, a, s, o, i, n, l, c) {
                if (a && "object" == typeof a && !Array.isArray(a))
                  for (var u in (t(a, s, o, i, n, l, c), a)) {
                    var h = a[u];
                    if (Array.isArray(h)) {
                      if (u in p.arrayKeywords)
                        for (var d = 0; d < h.length; d++)
                          e(r, t, h[d], s + "/" + u + "/" + d, o, s, u, a, d);
                    } else if (u in p.propsKeywords) {
          ...
          (p.keywords = {
            ...
            (p.arrayKeywords = { items: !0, allOf: !0, anyOf: !0, oneOf: !0 }),
            (p.propsKeywords = {
              definitions: !0,
              properties: !0,
              patternProperties: !0,
            ...
            (function(e) {
              ...
              function _(e) {
                ...
                if (s) {
                  ...
                  if (r.unicodeSupport || (o && o.unicodeSupport)) g(t, a);
                  else {
      ...
      ajv: [
        function(a, e, r) {
          ...
          var u = a("./keyword");
          (g.prototype.addKeyword = u.add),
            (g.prototype.getKeyword = u.get),
            (g.prototype.removeKeyword = u.remove);
