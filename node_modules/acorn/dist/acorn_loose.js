(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ...
    : factory(
        ((global.acorn = global.acorn || {}), (global.acorn.loose = {})),
        global.acorn
      );
  ...
  lp$1.parseClass = function(isStatement) {
    ...
    while (!this.closes(__acorn.tokTypes.braceR, indent, line)) {
      ...
      if (
        ...
        isAsync = true;
        isGenerator =
          this$1.options.ecmaVersion >= 9 && this$1.eat(__acorn.tokTypes.star);
        this$1.parsePropertyName(method);
      } else {
        isAsync = false;
      }
  ...
  lp$2.parseObj = function() {
    ...
    while (!this.closes(__acorn.tokTypes.braceR, indent, line)) {
      var prop = this$1.startNode(),
        ...
        start = void 0;
      if (
        this$1.options.ecmaVersion >= 9 &&
        this$1.eat(__acorn.tokTypes.ellipsis)
      ) {
      ...
      if (this$1.eat(__acorn.tokTypes.colon)) {
        ...
        (this$1.tok.type !== __acorn.tokTypes.comma &&
          ...
          this$1.tok.type !== __acorn.tokTypes.eq)
      ) {
